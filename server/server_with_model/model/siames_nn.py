...
class Siames_NN():
    ...
    def __load_siames_nn(self):
        ...
        def euclidean_distance_output_shape(shapes):
            ...
            return (shape1[0], 1)
        # print("1111111116")
        distance = Lambda(function=euclidean_distance, output_shape=euclidean_distance_output_shape)([left_network, right_network])
        # print("1111111117")
        model = Model(inputs=[input_left, input_right], outputs=distance)
        # print("1111111118")
        model.load_weights('.\server_with_model\model\weight_v2.h5', skip_mismatch=False)
        # print("111111119")
        return model
